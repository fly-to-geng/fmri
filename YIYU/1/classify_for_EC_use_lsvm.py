...
data_path = r'D:\FMRI_ROOT\YIYU\MVPA\features_vs_labels_from_DCM_DMN_DAN_SN.npy'
feature_names = r'D:\FMRI_ROOT\YIYU\MVPA\features_vs_labels_from_DCM_DMN_DAN_SN_vs_names.npy'
n_folds = 5
...
svc = linear_model.LogisticRegression(C=100, penalty='l2', tol=0.0001)
...
scores = cross_validation.cross_val_score(svc, X,y, cv=n_folds)
