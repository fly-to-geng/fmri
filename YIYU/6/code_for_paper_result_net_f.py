...
# 功能连接特征
features = r'features_from_fc_DMN_DAN_SN.mat'
features_name = r'features_from_fc_DMN_DAN_SN_vs_names.mat'
y_path = r'y.npy'
...
Ks = np.linspace(1,55,55).astype(int)
...
svc_linear =  SVC(C=1,kernel="linear")
cv = LeavePOut(y.shape[0], p=1)
sk_f = SelectKBest(f_classif,k=47)
score_linear_svc = []
feaure_indexs = []
