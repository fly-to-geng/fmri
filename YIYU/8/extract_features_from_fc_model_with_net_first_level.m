...
% 
fc_first_level_root = 'D:\FMRI_ROOT\YIYU\CONN\conn_project03\results\firstlevel\ANALYSIS_02\';
save_path = 'D:\FMRI_ROOT\YIYU\CONN\conn_project03\meresult\data';
...
for i=1:size(first_sub,1)
    ...
    subjects{i} = Z(1:region_num,1:region_num);% 116个AAL脑区
end
