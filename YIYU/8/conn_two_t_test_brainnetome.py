...
读取AAL模版数据
"""
aal_file = r'D:\FMRI_ROOT\YIYU\ROIs\brainnetome_x\x_subregions.xlsx'
import xlrd
...
for i in range(1,273):
    ...
    network_names.append( table.cell(i,8).value )
...
worksheet = workbook.add_sheet('sample_two_t_br')#################################
...
workbook.save(r't_test_brainnetome.xls')