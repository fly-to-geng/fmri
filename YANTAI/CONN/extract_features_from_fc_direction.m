...
% 方位
fc_first_level_root = 'D:\FMRI_ROOT\YANTAI\CONN\conn_project_2classd_func_brainnetome\results\firstlevel\ANALYSIS_01\';
save_path = 'D:\FMRI_ROOT\YANTAI\CONN\conn_project_2classd_func_brainnetome\classresult\';
...
% 方位
save('L_funtional_conectivity_matrix_from_brainnetome','JX_matrix');
save('R_funtional_conectivity_matrix_from_brainnetome','DW_matrix');
%save('funtional_conectivity_matrix_from_first_level_vs_names','region_names');
...
% 方位
save('features_L_brainnetome','JX_features_mat');
save('features_R_brainnetome','RL_features_mat');
%save('features_from_fc_aal_first_level_vs_names','brain_map_names');
...
cd(save_path);
save('features_brainnetome_LR','features_brainnetome');
