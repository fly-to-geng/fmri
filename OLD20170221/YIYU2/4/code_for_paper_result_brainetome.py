...
#Ks = np.linspace(10,2000,20).astype(int)
Ks = np.linspace(270,310,21).astype(int)
...
# 选出来特征选择 272个， 分类器选择线性linear_svm， 计算特征排序  准确率76.60%

cv = LeavePOut(y.shape[0], p=1)
sk_f = SelectKBest(f_classif,k=272)
score_linear_svc = []
feaure_indexs = []
...
import xlrd
brainnetome_file = r'D:\FMRI_ROOT\YIYU\ROIs\brainnetome\BNA_subregions.xlsx'
