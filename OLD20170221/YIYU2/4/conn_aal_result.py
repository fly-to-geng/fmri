...
func_matrix_aal_name = r'matrix_func_conn_aal_106.mat'
func_matrix_aal_names_name = r'matrix_func_conn_aal_106_names.mat'
labels_path = r'y.npy'
features_name = r'features_from_fc_aal_106_vs_names.mat'
# 加载数据转成python格式
...
for i in range(len(brain_region_names)):
    ...
    str2 = str2 + '\n'
os.chdir(os.path.join(root,'func_result'))
file_object = open(r'regions_aal_106_for_ring.data.txt', 'w')
...
# 写入连接信息
file_object = open(os.path.join(root,'func_result','all_subjects_links.txt'),'w')
