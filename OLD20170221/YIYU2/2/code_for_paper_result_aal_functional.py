...
brain_region_names_path = r'D:\FMRI_ROOT\YIYU\MVPA\features_from_fc_aal_first_level_vs_names.mat'
y_path = r'D:\FMRI_ROOT\YIYU\MVPA\features_from_fc_brainnetome_second_level_vs_labels.npy'
X_path = r'D:\FMRI_ROOT\YIYU\MVPA\features_from_fc_aal_second_level.mat'
...
worksheet = workbook.add_sheet('region_weight_whole_func_fabs')
...
workbook.save(r'Paper\result\MDD-HD-AAL-Functional_fabs.xls')   
...
import os
os.chdir(root)
root = r'D:\FMRI_ROOT\YIYU\MVPA\Paper\network_info'
str2 = ''   
...
file_object = open(root + r'\aal_functional_region.txt', 'w')
